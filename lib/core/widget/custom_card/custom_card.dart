...
class _CustomCardState extends State<CustomCard> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    colorAnimation=ColorTween(
      begin: widget.color1??AppColors.general,
      end: widget.color2??AppColors.general
      ...
      builder: (BuildContext context, Widget? child) {
        return InkWell(
          ...
          child: Card(
            ...
            child: Padding(
              padding: widget.padding ?? AppPadding.edgeAll16,
              child: Row(
                ...
                children: [
                  ...
                  if (widget.title != null)
                    Center(
                      child: Text(
                        widget.title!,
                        style: AppTextStyles.bodyLarge.copyWith(color: colorAnimation.value),
